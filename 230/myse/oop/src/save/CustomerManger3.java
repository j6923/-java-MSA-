...
public class CustomerManger3 {
	public static void main(String[] args) {
		...
		System.out.println("작업 구분: 1-고객추가, 2- 저장소 정보, 3-고객전체 조회, 4-아이디로 검색, 9-종료");
		
			
			
			
		java.util.Scanner sc; //스캐너라는 라이브러리 있어야 
		sc = new java.util.Scanner(System.in);
		String readValue; //do와 while조건에서도 사용하기 위해 여기에도 변수 선언 
		do {
		//입력받음
